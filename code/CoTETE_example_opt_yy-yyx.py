    ...
    def objective(trial):
        ...
        configs = {
            "model_config_yy": {
                ...
                "context_extractor": trial.suggest_categorical("context_extractor", ["gru", "lstm", "mlp"]), # Type of RNN to use for context extraction, ["gru", "lstm", "mlp"]
            ...
            "train_config_yy": {
                ...
                "learning_rate": trial.suggest_float("learning_rate", 5e-5, 1e-2, log=True),           # Learning rate for Adam optimizer
...
if __name__ == "__main__":
    ...
    study = optuna.create_study(directions=["minimize"], storage="sqlite:///db.sqlite3"
                                ,load_if_exists=True, study_name=f"CoTETE_yy+yyx_{seed:02d}_{num_source_events:.0e}") # Set direction to 'maximize' for TE,  
